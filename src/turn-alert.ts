...
export let debug = (...args) => {if (debugEnabled > 1) console.log(`DEBUG:${TURN_ALERT_MODULE_NAME} | `, ...args)};
export let log = (...args) => console.log(`${TURN_ALERT_MODULE_NAME} | `, ...args);
export let warn = (...args) => {if (debugEnabled > 0) console.warn(`${TURN_ALERT_MODULE_NAME} | `, ...args)};

...
import { getGame } from './scripts/settings';
...
export const debug = (...args) => {
  if (debugEnabled > 1) console.log(`DEBUG:${TURN_ALERT_MODULE_NAME} | `, ...args);
};
export const log = (...args) => console.log(`${TURN_ALERT_MODULE_NAME} | `, ...args);
export const warn = (...args) => {
  if (debugEnabled > 0) console.warn(`${TURN_ALERT_MODULE_NAME} | `, ...args);
};

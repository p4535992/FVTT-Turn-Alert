...
export class TurnAlertRepeating {
  frequency: number; // The number of rounds in a period before the alert triggers again
  expire: number; // The round number on which this repeating alert expires. If expireAbsolute is *false*, this will be relative to the initial trigger round of the alert. If zero or null, will not expire.
  expireAbsolute: boolean; // Whether the expire round is absolute or not
}

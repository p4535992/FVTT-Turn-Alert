...
export default class CombatAlertsApplication extends Application {
    ...
    _createAlertDisplayData(alertTmp) {
        ...
        const macroName = (getGame().macros?.get(alertTmp.macro) || getGame().macros?.getName(alertTmp.macro))?.data?.name;
        return {
            id: alertTmp.id,
